...
namespace Mega_World_Mall_Linking.Services
{
    public static class DiscountDetailFileGenerator
    {
        public static void GenerateFile(DiscountDetailFile data, string outputDirectory)
        {
            ...
            int safeBatch = Math.Min(9, Math.Max(1, data.BatchNumber));
            ...
            Logger.LogInfo($"Discount Detail file generated: {fileName} in {outputDirectory} (Batch: {safeBatch}, Entries: {data.Entries.Count})");
        }
