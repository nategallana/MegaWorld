...
namespace Mega_World_Mall_Linking.Constant
{
    public class Queries
    {
        ...
        public const string SELECT_TABLE_Top1 = "SELECT * FROM {0} WHERE {1} ORDER BY Time ASC LIMIT 1";
        ...
        public const string SELECT_TABLE_WHERE_LIMIT_ASC = "SELECT * FROM {0} WHERE {1} ORDER BY Time ASC LIMIT 1";
        public const string SELECT_TABLE_WHERE_LIMIT_DESC = "SELECT * FROM {0} WHERE {1} ORDER BY Time DESC LIMIT 1";
        ...
        public const string GET_STARTHOUR = "SELECT Time FROM {0} WHERE AccDate = '{1}' ORDER BY Time ASC LIMIT 1";
        public const string GET_ENDHOUR = "SELECT Time FROM {0} WHERE AccDate = '{1}' ORDER BY Time DESC LIMIT 1";
